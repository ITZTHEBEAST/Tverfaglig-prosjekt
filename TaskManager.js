...
xhr.onload = function () {
    if (xhr.status == 200) {
        try {
            ...
            console.log("Response JSON:", response); // Log the entire response for debugging
            ...
            console.error('Raw response text:', xhr.responseText); // Log the raw response text for debugging
        }
    } else {
...
xhr.send("taskText=" + encodeURIComponent(taskText));
